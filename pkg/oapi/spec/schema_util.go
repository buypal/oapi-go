...
const (
	TypeBoolean OAPIType = "boolean"
	TypeNumber  OAPIType = "number"
	TypeInteger OAPIType = "integer"
	TypeString  OAPIType = "string"
	TypeObject  OAPIType = "object"
	TypeArray   OAPIType = "array"
)
